...
const LineaBook = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 4z" />
  </svg>
);
...
function Sidebar() {
  ...
  const menuItems = [
    { path: '/', name: 'Trang chủ', icon: LineaHome },
    { path: '/alphabet', name: 'Bảng chữ cái', icon: LineaBook },
      ...
      <nav className="sidebar-nav">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              <span className="sidebar-link-icon-wrapper" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minWidth: '1.75rem' }}>
                <IconComponent />
              </span>
